...
IPC-System-V/
│
├── Pipe_Examples/     # Basic pipe programs (read/write, simple demos)
├── Named_Pipe/        # FIFO-based IPC (unrelated processes)
├── Unnamed_Pipe/      # Parent-child communication using pipe()
├── Message_Queue/     # Message-based IPC
├── Signals/           # Signal handling programs
├── Shared_Memory/     # Memory-sharing examples
└── README.md
